...
sub OutputDebug {
	...
	print DEBUG_OUT "# Give this to the developer to assist him in debugging your problem\n\n";
	print DEBUG_OUT "echo 'Common Configuration Parser debugging script revision 1'\n";
